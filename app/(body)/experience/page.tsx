        ...
        <div className="flex flex-col gap-16">
          ...
          <div className="flex flex-col gap-12 max-w-[70ch]">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-soft-pewter text-heading-3">
              ...
              <ul className="list-disc pl-4 flex flex-col gap-2 text-soft-pewter">
                ...
                <li>
                  Collaborated directly with clients to define project scopes
                  and deliver tailored solutions that met business needs.
                </li>
                <li>
                  Implemented SEO strategies to enhance site visibility and
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-disc pl-4 flex flex-col gap-2 text-soft-pewter">
                <li>
                  Built and maintained custom WordPress themes, transitioning
